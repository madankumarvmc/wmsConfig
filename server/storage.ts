...
export interface IStorage {
  ...
  getTaskPlanningConfigurationByGroup(inventoryGroupId: number): Promise<TaskPlanningConfiguration | undefined>;
  ...
  getTaskExecutionConfigurationByGroup(inventoryGroupId: number): Promise<TaskExecutionConfiguration | undefined>;
...
export class MemStorage implements IStorage {
  ...
  async getTaskPlanningConfigurationByGroup(inventoryGroupId: number): Promise<TaskPlanningConfiguration | undefined> {
    return Array.from(this.taskPlanningConfigurations.values())
      .find(config => config.inventoryGroupId === inventoryGroupId);
  }
  ...
  async saveTaskPlanningConfiguration(config: InsertTaskPlanningConfiguration): Promise<TaskPlanningConfiguration> {
    ...
    const newConfig: TaskPlanningConfiguration = { 
      ...
      statePreferenceOrder: config.statePreferenceOrder || ['PURE'],
      statePreferenceSeq: config.statePreferenceSeq || ['PURE'],
      areaTypes: config.areaTypes || ['INVENTORY'],
      areas: config.areas || []
    };
  ...
  async updateTaskPlanningConfiguration(id: number, config: Partial<InsertTaskPlanningConfiguration>): Promise<TaskPlanningConfiguration | undefined> {
    ...
    const updated: TaskPlanningConfiguration = { ...existing, ...config };
  ...
  async getTaskExecutionConfigurationByGroup(inventoryGroupId: number): Promise<TaskExecutionConfiguration | undefined> {
    return Array.from(this.taskExecutionConfigurations.values())
      .find(config => config.inventoryGroupId === inventoryGroupId);
  }
  ...
  async saveTaskExecutionConfiguration(config: InsertTaskExecutionConfiguration): Promise<TaskExecutionConfiguration> {
    ...
    const newConfig: TaskExecutionConfiguration = { 
      ...
      ...config,
      huKinds: config.huKinds || [],
      loadingUnits: config.loadingUnits || ['CRATE']
    };
  ...
  async updateTaskExecutionConfiguration(id: number, config: Partial<InsertTaskExecutionConfiguration>): Promise<TaskExecutionConfiguration | undefined> {
    ...
    const updated: TaskExecutionConfiguration = { ...existing, ...config };
